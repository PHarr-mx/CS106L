...
void print_difference(const HashMap<string, int> &lecturer_record, string lecturer1, string lecturer2) {
    ...
    if (year1 < year2) {
        cout << lecturer1 << " lectured first and " << year2 - year1 << " year(s) later, " << lecturer2 << " lectured"
             << endl;
    } else if (year1 > year2) {
        cout << lecturer2 << " lectured first and " << year1 - year2 << " year(s) later, " << lecturer1 << " lectured"
             << endl;
    } else {
